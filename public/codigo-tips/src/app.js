...
function addCycleZoneBands(chart, data) {
  ...
  const zones = [
    { base: 42, value: 0,  color: 'rgba(59,139,212,0.05)'   }, // compressão: 0–42
    { base: 52, value: 42, color: 'rgba(239,159,39,0.05)'   }, // aceleração: 42–52
    { base: 58, value: 52, color: 'rgba(226,75,74,0.05)'    }, // explosão: 52–58
    { base: 58, value: maxVal, color: 'rgba(163,45,45,0.05)'}, // explosão forte: 58+
  ];
...
function addCycleThresholds(goalsSeries) {
  ...
  goalsSeries.createPriceLine({
    price: 42, color: 'rgba(59,139,212,0.05)', lineWidth: 1, lineStyle: 2,
    axisLabelVisible: true, title: 'Compressão',
  });
  goalsSeries.createPriceLine({
    price: 48, color: 'rgba(136,135,128,0.05)', lineWidth: 1, lineStyle: 1,
    axisLabelVisible: true, title: 'Média',
  });
  goalsSeries.createPriceLine({
    price: 58, color: 'rgba(226,75,74,0.05)', lineWidth: 1, lineStyle: 2,
